...
<form method="post" enctype="multipart/form-data" style="width: 100px; display: inline-block; vertical-align: top; margin: 5px;" onSubmit="change_name();">
	<label style="cursor: pointer;"><img src="<?php echo $url;?>/lms/dashboard/images/img_upload.png" id="yourImgTag" style="width: 100px; height: 100px; object-fit: cover;">
...
<img src="<?php echo $url;?>/lms/dashboard/paper_img/<?php echo $img_resalt['pi_image']; ?>">
