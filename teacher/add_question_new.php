...
<head>
    ...
    <title>Add Question Teacher Panel | Online Learning Platforms |  demolms.lk</title>
	<!-- Favicon icon -->
...
<div class="form-group">
<input name="ans_2" type="text" required="required" class="form-control" id="ans_2" placeholder="Answer 1" value="<?php if(isset($_GET['id'])){echo $view_resalt['ans_2'];} ?>">
</div>
<div class="form-group">
<input name="ans_3" type="text" required="required" class="form-control" id="ans_3" placeholder="Answer 1" value="<?php if(isset($_GET['id'])){echo $view_resalt['ans_3'];} ?>">
</div>
<div class="form-group">
<input name="ans_4" type="text" required="required" class="form-control" id="ans_4" placeholder="Answer 1" value="<?php if(isset($_GET['id'])){echo $view_resalt['ans_4'];} ?>">
</div>
...
<button name="<?php if(isset($_GET['id'])){echo "update_btn";}else{echo "submit_btn";} ?>" type="submit" class="btn btn-success"><?php if(isset($_GET['id'])){echo "Update Questions";}else{echo "Add New &amp; Next";} ?></button>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="#" target="_blank">Yogee Media</a> 2021</p>
            </div>
        </div>
        <!--**********************************
            Footer end
