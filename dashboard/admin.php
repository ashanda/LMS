							...
							<div id="list-view" class="tab-pane fade active show col-lg-12">
								...
								?>
													<tr>
														...
														<td>
														<p><strong>Admin - <span class="badge badge-pill badge-secondary"><?php echo $row['admin']; ?></span><strong><p>
														<p>Students - <span class="badge badge-pill badge-secondary"><?php echo $row['students']; ?></span><strong><p>
														<p>Teachers - <span class="badge badge-pill badge-secondary"><?php echo $row['teachers']; ?></span><strong><p>
														<p>Class - <span class="badge badge-pill badge-secondary"><?php echo $row['class']; ?></span><strong><p>
														<p>Subject - <span class="badge badge-pill badge-secondary"><?php echo $row['subject']; ?></span><strong><p>
														<p>Lesson - <span class="badge badge-pill badge-secondary"><?php echo $row['lesson']; ?></span><strong><p>
														<p>Payments - <span class="badge badge-pill badge-secondary"><?php echo $row['payments']; ?></span><strong><p>
														<p>Class Schedule - <span class="badge badge-pill badge-secondary"><?php echo $row['class_schedule']; ?></span><strong><p>
														<p>Mail - <span class="badge badge-pill badge-secondary"><?php echo $row['mail']; ?></span></strong></p>
														</td>
														<td>
														<?php 
