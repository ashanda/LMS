...
?>
<tr valign="middle">
<td style="width: 20px;"><input type="checkbox" name="lavel[]" <?php if($lmsck_level_val==1){echo "checked";} ?> id="<?php echo "level".$level_resalt['cid']; ?>" value="<?php echo $level_resalt['cid']; ?>"></td>
...
?>
<tr valign="middle">
<td style="width: 20px;"><input type="checkbox" name="subject[]" <?php if($lmsck_subject_val==1){echo "checked";} ?> id="<?php echo "subject".$subject_resalt['sid']; ?>" value="<?php echo $subject_resalt['sid']; ?>"></td>
