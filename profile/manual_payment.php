	...
	<div class="wrapper">
		<div class="sa4d25">
			<div class="container-fluid">			
				<div class="row">
					<div class="col-lg-12">	
						<h2 class="st_title"> Manual Payments History</h2>
					</div>					
				</div>				
				<div class="row">					
...
?> <?php echo $cl_resalt['name']; ?> <?php }} ?> 
										...
										<td><a href="<?php echo "https://lmsalmaths.com/profile/uploadslip/".$payment_resalt['fileName']; ?>" target="_blank" class="badge badge-primary">View Slip</a></td>	
