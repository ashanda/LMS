...
<head>
	...
	<title>Free Class | Online Learning Platforms  | Student Panel</title>
	<?php
	...
	<div class="wrapper">
		<div class="sa4d25">
			<div class="container-fluid">
				<div class="row">
				<div class="col-lg-12">
				<h4 class="item_title">Free Live Classes</h4>
				<br>
...
$lavel_qury=mysqli_query($conn,"SELECT * FROM lmsclass_schlmsle WHERE level='$user_resalt[level]' and subject IN ($sub_array_join) and classtype='Free Class' and classstatus='1' and add_date BETWEEN '$s_month' and '$e_month' and subject='$fsubject'");
						...
						?>
										...
										<div class="fcrse_content">
											...
											<div class="auth1lnkprce">
												...
												<br>
												<a href="<?php echo $level_resalt['classlink']; ?>" class="save_btn btn-block" target="_blank">Go Live</a>	    
												</div>
											</div>
...
$lavel_qury=mysqli_query($conn,"SELECT * FROM lmsclass_schlmsle WHERE level='$user_resalt[level]' and subject IN ($sub_array_join) and classtype='Free Class' and classstatus='1'");
while($level_resalt=mysqli_fetch_array($lavel_qury)){
