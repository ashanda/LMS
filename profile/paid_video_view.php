...
<html lang="en">
	...
	<title>Paid Video Lesson View | Online Learning Platforms | Student Panel</title>
	<?php
...
if (isset($_GET['video']))
{
								$stmt = $DB_con->prepare("SELECT * FROM lmslesson where lid='" . $_GET['video'] . "' and type='Paid' and status='1' order by lid ASC");
